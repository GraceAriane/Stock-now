package com.example.stocknow.screens.export
...
import com.example.stocknow.ui.viewmodels.ExportViewModel
...
fun ExportScreen(viewModel: ExportViewModel = viewModel()) {
    ...
    Column(
        ...
        // AJOUT : Affichage d'une barre de progression si un export est en cours
        if (isExporting) {
        ...
        LazyColumn(
            ...
            item {
                ...
                // Message de statut après export
...
fun ExportCard(
    ...
    Card(
        ...
        Row(
            ...
            Button(
                onClick = onClick, // Liaison à l'action
                enabled = !isLoading, // Désactivé si déjà en cours
